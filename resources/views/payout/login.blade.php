        ...
        <div style="max-width: 350px;" class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div style="padding: 30px 40px;" class="modal-body">
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Enter your OTP</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="Enter your otp">
                    </div>
                    <button
                        style="padding: 3px 15px;text-align: right;width: fit-content;margin-bottom: 20px;font-size: 12px;float: right;background-color: #002a48;opacity: 1;border: none;"
                        class="btn btn-primary" type="button" disabled>
                        <span style="width: .6rem; height: .6rem;" class="spinner-border spinner-border-sm"
...
<div class="modal fade payout-model otp-modal" id="mobile_otp_model" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="payout_otp_form">
                    <center>
                        <p style="width:100%;padding: 5px;">To complete user registration please enter OTP which is sent
                            to <b>****{{substr(session('success'), -2)}}</b></p>
                        ...
                        <button class="btn login-btn" id="otp_submit" type="button">Submit</button>
                    </center>
                </form>
